...
### Final Dashboard:
![SALES EXCEL DASHBOARD/DASHBOARD](IMAGES/SALES EXCEL DASHBOARD/DASHBOARD.png)
### Objectives:
##### •	Created data visualization tools to monitor sales activity ,sales by category and suggested improvement strategies.
![tbl4.1](IMAGES/SALES EXCEL DASHBOARD/tbl4.1.png)
![tbl2.1](IMAGES/SALES EXCEL DASHBOARD/tbl2.1.png)
